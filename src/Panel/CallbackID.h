...
#define DEFINE_ID_NAME_ENTRY(x) \
	{ CallbackID::x, PFC_WIDESTRING(#x) }

static const std::map<CallbackID, std::wstring> g_callback_name_map =
{
	...
	DEFINE_ID_NAME_ENTRY(on_download_file_done),
	...
	DEFINE_ID_NAME_ENTRY(on_http_request_done),
...
static const std::map<uint32_t, CallbackID> g_msg_callback_map =
{
