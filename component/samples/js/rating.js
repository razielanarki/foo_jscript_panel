function _rating(x, y, h, colour) {
	...
	this.rbtn_up_done = function (idx) {
		...
		case idx == 1004:
			...
			break;
		case idx == 1005:
			var tmp = Number(utils.InputBox(window.ID, 'Enter a maximum value. Defaults to "5" if left blank.', window.Name, this.properties.max.value));
