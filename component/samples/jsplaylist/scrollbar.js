function PlaylistScrollBar() {
	...
	this.setButtons = function () {
		...
		gb.DrawString(chars.up, g_font_awesome_12, g_color_normal_txt & 0x55ffffff, 0, 0, this.w, this.w, cc_stringformat);
		...
		gb.SetTextRenderingHint(4);
		gb.DrawString(chars.up, g_font_awesome_12, g_color_normal_txt & 0x99ffffff, 0, 0, this.w, this.w, cc_stringformat);
		...
		gb.SetTextRenderingHint(4);
		gb.DrawString(chars.up, g_font_awesome_12, g_color_normal_txt, 0, 0, this.w, this.w, cc_stringformat);
		...
		gb.SetTextRenderingHint(4);
		gb.DrawString(chars.down, g_font_awesome_12, g_color_normal_txt & 0x55ffffff, 0, 0, this.w, this.w, cc_stringformat);
		...
		gb.SetTextRenderingHint(4);
		gb.DrawString(chars.down, g_font_awesome_12, g_color_normal_txt & 0x99ffffff, 0, 0, this.w, this.w, cc_stringformat);
		...
		gb.SetTextRenderingHint(4);
		gb.DrawString(chars.down, g_font_awesome_12, g_color_normal_txt, 0, 0, this.w, this.w, cc_stringformat);
