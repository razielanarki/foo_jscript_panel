...
function oInputbox(w, h, default_text, empty_text, func, id, font_size) {
	...
	this.draw = function (gr, x, y) {
		...
		// draw bg
		if (this.bordercolor) {
			gr.DrawRect(x - 2, y, (this.w + 4) - 1, this.h - 1, 1, this.bordercolor);
		}
		...
		if (this.text.length > 0) {
			gr.GdiDrawText(this.text.substr(this.offset), g_font_12, this.edit ? this.textcolor : blendColors(this.textcolor, this.backcolor, 0.5), this.x, this.y, this.w, this.h, DT);
		} else {
			gr.GdiDrawText(this.empty_text, g_font_12, blendColors(this.textcolor, this.backcolor, 0.5), this.x, this.y, this.w, this.h, DT);
		}
		// draw cursor
