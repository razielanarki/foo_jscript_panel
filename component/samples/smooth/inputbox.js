...
function oInputbox(w, h, default_text, empty_text, textcolor, backcolor, bordercolor, backselectioncolor, func) {
	...
	this.draw = function (gr, x, y) {
		...
		if (this.bordercolor)
			gr.FillSolidRect(x - 2, y, (this.w + 4), this.h, this.bordercolor);
		...
		// draw text
		gr.GdiDrawText(this.text.length > 0 ? this.text.substr(this.offset) : this.empty_text, this.font, blendColors(this.textcolor, (this.backcolor == 0 ? 0xff000000 : this.backcolor), 0.35), this.x, this.y, this.w, this.h, DT);
		// draw cursor
